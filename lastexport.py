...
#Originally file located here http://bugs.foocorp.net/projects/librefm/wiki/LastToLibre
...
def get_options(parser):
    ...
    parser.add_option("-u", "--user", dest="username", default=None,
                      help="User name.")
    parser.add_option("-o", "--outfile", dest="outfile", default=".scrobbler.log",
...
def main(server, username, startpage, outfile, infotype='recenttracks', tracksperdayarg=100):
    trackdict = dict()
    global tracksperday
